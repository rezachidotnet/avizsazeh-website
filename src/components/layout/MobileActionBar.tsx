...
export function MobileActionBar() {
  ...
  const whatsapp = `https://wa.me/98${company.mobile.replace(/^0/, '')}`;
  ...
  return (
    ...
    >
      <div className="grid grid-cols-2 gap-2 p-2">
        <Link
          href="/rfq"
          className="flex h-12 items-center justify-center gap-2 rounded-sm bg-gold px-4 text-[0.78rem] font-semibold uppercase tracking-[0.06em] text-ink-950"
        >
        ...
        <a
          ...
          className="flex h-12 items-center justify-center gap-2 rounded-sm border border-white/20 px-4 text-[0.78rem] font-semibold uppercase tracking-[0.06em] text-white"
        >
