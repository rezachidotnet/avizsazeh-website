  ...
  return (
    <>
      ...
      <Section>
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-7">
            ...
            <h2 className="mt-10 font-display text-h3 font-semibold text-ink">
              {t('storyTitle')}
            </h2>
          ...
          <div className="lg:col-span-5">
            <div className="relative aspect-[4/5] overflow-hidden rounded-lg border border-ink/10 bg-ink-100">
              <Image
      ...
      <Section ivory>
        ...
        <ul className="mt-10 grid gap-px overflow-hidden rounded-lg border border-ink/10 bg-ink/10 sm:grid-cols-2">
          {principles.map((p, i) => (
      ...
      <Section>
        <div className="grid gap-6 md:grid-cols-3">
          {pillars.map((pillar) => (
            <div
              key={pillar.title}
              className="flex h-full flex-col rounded-lg border border-ink/10 bg-ink/[0.03] p-7"
            >
              ...
              <h3 className="mt-6 text-h4 font-semibold text-ink">{pillar.title}</h3>
          ...
          <div className="lg:col-span-6">
            ...
            <ul className="mt-5 flex flex-wrap gap-3">
              {values.map((v) => (
                <li
                  key={v}
                  className="inline-flex items-center gap-2 rounded-sm border border-ink/10 bg-ink/[0.04] px-4 py-3 text-body-s font-medium text-ink-700"
                >
      ...
      <Section>
        ...
        <div className="mt-8 flex items-center gap-4 rounded-lg border border-dashed border-ink/15 bg-ink/[0.02] px-6 py-7">
