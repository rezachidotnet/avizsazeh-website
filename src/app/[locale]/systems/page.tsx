  ...
  return (
    <>
      ...
      <Section>
        ...
        <div className="mt-12 flex flex-col items-start gap-4 rounded-lg border border-ink/10 bg-ink/[0.03] p-8 sm:flex-row sm:items-center sm:justify-between">
      ...
      <Section ivory className="!pt-0 lg:!pt-0">
        <div className="grid gap-10 rounded-lg border border-ink/10 bg-ink/[0.03] p-8 lg:grid-cols-12 lg:p-12">
          ...
          <ul className="grid gap-px self-start overflow-hidden rounded border border-ink/10 bg-ink/10 sm:grid-cols-2 lg:col-span-7">
            {factors.map((f) => (
